...
execute_process(
  COMMAND "/bin/git" --git-dir=.git show-ref "v3.5.4"
  WORKING_DIRECTORY "/home/raghavp/BTP/vendor_server/build/_deps/catch2-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/raghavp/BTP/vendor_server/build/_deps/catch2-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/raghavp/BTP/vendor_server/build/_deps/catch2-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
